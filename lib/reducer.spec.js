...
describe('reducer', () => {
  describe('actions', () => {
    describe('performQuery', () => {
      it('returns the type and payload', () => {
        ...
        expect(performQuery(input)).toEqual(expected);
      });
    });
    ...
    describe('selectResult', () => {
      it('returns the type and payload', () => {
        ...
        expect(selectResult(id)).toEqual(expected);
      });
    });
    ...
    describe('setVisible', () => {
      it('returns the type and payload', () => {
        ...
        expect(setVisible(input)).toEqual(expected);
      });
    });
  });
  ...
  describe('reducer', () => {
    ...
    describe('QUERY_REQUESTED', () => {
      it('sets loading to true', () => {
        const action = { type: QUERY_REQUESTED, payload: 'testing' };
        expect(reducer(undefined, action)).toEqual({ ...initialState, query: 'testing', loading: true });
      });
    });
    ...
    describe('SELECT_RESULT', () => {
      ...
      it('resets query', () => {
        ...
        expect(reducer(existingState, action)).toEqual({ ...existingState, query: '' });
      });
      ...
      it('sets visible to false', () => {
        ...
        expect(reducer(existingState, action)).toEqual({ ...existingState, visible: false });
      });
    });

    describe('SET_VISIBLE', () => {
      it('sets visible', () => {
        const action = { type: SET_VISIBLE, payload: true };

        expect(reducer(initialState, action)).toEqual({ ...initialState, visible: true });
      });
    });
  });
